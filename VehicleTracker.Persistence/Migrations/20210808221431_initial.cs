    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RegistrationNumber = table.Column<string>(type: "varchar(50)", nullable: false),
                    ...
                    CurrentLocation_Longitude = table.Column<string>(type: "varchar(50)", nullable: true),
                    CurrentLocation_Latitude = table.Column<string>(type: "varchar(50)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarLocation_Longitude = table.Column<string>(type: "varchar(50)", nullable: true),
                    CarLocation_Latitude = table.Column<string>(type: "varchar(50)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleState_Vehicle_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleState_VehicleId",
                table: "VehicleState",
                column: "VehicleId");
        }
